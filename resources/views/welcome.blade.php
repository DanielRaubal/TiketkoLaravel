...
<body class="antialiased">
    <div class="h-screen md:flex">
        <div class="relative overflow-hidden md:flex w-1/2 bg-gradient-to-tr from-blue-800 to-purple-700 i justify-around items-center hidden">
            <div>
                <h1 class="text-white font-bold text-4xl font-sans">Тикетко</h1>
                <p class="text-white mt-1">Најјачи тикетинг систем у Србији</p>
        ...
        <div class="flex md:w-1/2 justify-center py-10 items-center bg-white">
            <form class="bg-white">
                ...
                <button type="submit" class="block w-28 bg-indigo-800 text-white mt-4 py-2 rounded-2xl font-bold mb-2" style="background-color: indigo;">Login</button>
